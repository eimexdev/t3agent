              ...
              threads: Arr.filterMap(threadRows, (row) =>
                row.deletedAt === null
                  ? Result.succeed({
                      ...
                      latestTurnlessAssistantMessageAt: row.latestTurnlessAssistantMessageAt,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        latestTurnlessAssistantMessageAt: threadRow.value.latestTurnlessAssistantMessageAt,
